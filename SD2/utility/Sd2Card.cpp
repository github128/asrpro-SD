...
static  uint8_t spiRec(void) { //修改 1 
  retrun softspi4.wr_data(0xff);
}
//------------------------------------------------------------------------------
/** Soft SPI send */
void spiSend(uint8_t data) {  //修改2
softspi4.wr_data(data);
...
*/
uint8_t Sd2Card::init(uint8_t sckRateID, uint8_t chipSelectPin) {  //修改3
  ...
  softspi4.begin(5,3,6);   //修改 softspi sck mosi miso 
  // set pin modes
